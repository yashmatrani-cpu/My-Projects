...
print('''this programm can perform these simple tasks:
         ...
         ''')
jmc = input("what do you wan to do press 1,2,3,4,5 for each tasks respectively ex i want to do simplify so i will press '5' ")
match jmc:
    case '1':
...
{pair_a2}x + {pair_b2}y + {pair_c2} = 0''')
    ...
    case '5':
        ...
        print(result)     
    case '6':
         yc = input('what do you want,press 1-submission,2-subtraction,3-multiplication,4-division,5-remender')
         match yc:
            case '1':            
                    def sum():
                      total = 0
